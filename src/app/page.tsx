  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div
            className={`card border-l-4 ${filter === 'good' ? '!bg-green-100' : 'border-green-600'} text-center cursor-pointer transition-all hover:bg-gray-50`}
            onClick={() => setFilter(prev => prev === 'good' ? 'all' : 'good')}
          >
          ...
          <div
            className={`card border-l-4 ${filter === 'warning' ? '!bg-orange-100' : 'border-orange-500'} text-center cursor-pointer transition-all hover:bg-gray-50`}
          ...
          <div
            className={`card border-l-4 ${filter === 'urgent' ? '!bg-red-100' : 'border-red-600'} text-center cursor-pointer transition-all hover:bg-gray-50`}
            onClick={() => setFilter(prev => prev === 'urgent' ? 'all' : 'urgent')}
          >
